...
function wx_config_Private(wxRoot, wxDebug, wxHost, wxVersion, wxStatic, wxUnicode, wxUniversal, wxLibs, wxWindowsCompiler)
	...
	function wx_config_for_windows(wxWindowsCompiler)
		...
		wxLibPath = path.join(wxLibPath, wxWindowsCompiler .. "_x64_" .. iif(wxStatic == 'yes', 'lib', 'dll'))
		-- common defines
		defines{ "__WXMSW__" }
...
--		for i, lib in ipairs({"wxjpeg", "wxpng", "wxzlib", "wxtiff", "wxexpat"}) do
		for i, lib in ipairs({"wxjpeg", "wxpng", "wxzlib", "wxtiff"}) do
...
function setupwxWidgets()
    WX_DIR = "%{BASE_DIR}external/wxwidgets33"
    filter "configurations:Debug"
        wx_config { Root=WX_DIR, Debug="yes", Static="yes", Unicode="yes", Version="3.3", Libs="core,adv,aui,propgrid,html" }
    filter "configurations:Release"
        wx_config { Root=WX_DIR, Debug="no", Static="yes", Unicode="yes", Version="3.3", Libs="core,adv,aui,propgrid" }
